...
const clothingValidationSchema = Yup.object({
  ...
  // New dropdown field for sleeve style
  sleeveStyle: Yup.string().required("Sleeve style is required"),
});

const clothingInitialValues = {
  name: "",
  description: "",
  price: "",
  discount: "",
  ...
  color: "",
  material: "",
  // New initial value for sleeve style
  sleeveStyle: "",
};

const ClothingForm = ({ userEmail }) => {
  ...
  const handleSubmit = async (values, { resetForm }) => {
    ...
    try {
      ...
      const response = await axios.post(
        ...
        }/api/seller-central/add-product-clothes`,
        productData
      );
  ...
  return (
    <div className="p-8 rounded-2xl w-full max-w-3xl bg-white shadow-2xl border mx-auto border-gray-100">
      ...
      <Formik
        initialValues={clothingInitialValues}
      ...
      >
        {({ setFieldValue, errors, touched, validateForm, submitForm }) => (
          <Form className="space-y-6">
            ...
            <Field type="hidden" name="category" value="clothing" />
